...
{ 
    public class TopicHelper
    {
        ...
        public TopicHelper(Source source, ILogger logger)
        {
            _source = source;
        ...
        public void process_topics()
        {
            ...
            else if (_source_type.ToLower() == "study" && _source.has_study_topics)
            {
        ...
        public void delete_topics(string sql_string, int rec_count, string delete_set)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _logger.Information("Deleting meaningless topics (group " + delete_set + ") - as a single batch");
                }
            }
            catch (Exception e)
            {
                string res = e.Message;
                _logger.Error("In deleting meaningless categories: " + res);
            }
        }
        ...
        public void identify_geographic(string source_type, string schema, int rec_count)
        {
            ...
            try
            {
                ...
                {
                    ExecuteSQL(sql_string);
                    _logger.Information("Identifying geographic topics - as a single batch");
                }
            }
            catch (Exception e)
            {
                string res = e.Message;
                _logger.Error("In identifying geographic topics: " + res);
            }
        }
        ...
        public void mesh_match_topics(string source_type, string schema, int rec_count)
        {
            ...
            try
            {
                ...
                {
                    ExecuteSQL(sql_string);
                    _logger.Information("Updating " + source_type + " topic codes - as a single batch");
                }
            }
            catch (Exception e)
            {
        ...
        public void mesh_remove_duplicates(string source_type, string schema, int rec_count)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    _logger.Information("Deleting duplicates in " + source_type + " topic codes - as a single batch");
                }
            ...
            {
                string res = e.Message;
                _logger.Error("In remove duplicate topics: " + res);
            }
        }
        ...
        public void store_unmatched_topic_values(string source_type, int source_id)
        {
            ...
            ExecuteSQL(sql_string);
            _logger.Information("Storing topic codes not matched to MESH codes");
        }
    }
}
